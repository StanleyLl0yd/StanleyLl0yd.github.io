(() => {
  ...
  const translations = {
    ...
    ru: {
      ...
      privacyPermissionsText: "Android запрашивает только разрешение на вибрацию для тактильной обратной связи и не запрашивает INTERNET. Версия Windows работает от имени текущего пользователя без повышения привилегий. Версия macOS использует App Sandbox и не имеет сетевого разрешения для функций продукта.",
